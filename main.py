...
password = "AirJordan1!"@client.on(events.NewMessage(chats=["bitfootpings"]))
async def forward(event):
    ...
    if trimmed:
        ...
        print(" Skipped: Trimmed message was empty\n" + "-" * 40)

except Exception as e:
    print(f" Error processing message: {e}")# === Async main ===
async def main():
    try:
        ...
        print(f" Bot error: {e}")if __name__ == "__main__":
